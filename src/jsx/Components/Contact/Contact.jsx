                ...
                <div className="container one">
                    ...
                    <div className="row contactInfo">
                        ...
                        <div className="col-12">
                            ...
                            <a href="https://github.com/piotrrawski" target="blank"><img className="icon" src="dist/images/github-logo-2.svg"></img></a>
                            <a href="http://www.linkedin.com/in/piotr-rawski" target="blank"><img className="icon" src="dist/images/linkedin-sign-2.svg"></img></a>
                        </div>
                    </div>
                </div>
